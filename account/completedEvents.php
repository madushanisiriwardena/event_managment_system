...
?>
    ...
    <head>
        ...
        <title>Event Managment System - My Completed Events</title>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
                        <div class="breadcrumbs-content">
                            <h1 class="page-title">My Completed Events</h1>
                            <ul class="breadcrumb-nav">
                                <li><a href="../index.php">Home</a></li>
                                <li>My Completed Events</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-9 ">
                        <div class="tab-content">
                            <div class="tab-pane fade active show">
                                <?php
                                $rs2 = Database::search("SELECT * FROM `quotation` WHERE `customer_id` = '" . $customer . "' AND `quotation_status_id`='5' OR `quotation_status_id`='6' ORDER BY `id` DESC");
                                $n2 = $rs2->num_rows;
                                if($n2>0){
                                for ($x = 0; $x < $n2; $x++) {
                                    ...
                                    <div class="card-body pb-2">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <br>
                                                <?php
                                                if ($category["quotation_status_id"] == "5") {
                                                ?>
                                                    ...
                                                    ?>
                                                        <a href="weddingInfo.php?id=<?php echo $category["id"]; ?>" class="btn btn-secondary">View More</a>
                                                    <?php
                                                    } else if ($srow21["categories_id"] == 6) {
                                                    ?>
                                                        <a href="birthdayInfo.php?id=<?php echo $category["id"]; ?>" class="btn btn-secondary">View More</a>
                                                    <?php
                                                    }
                                                    ?>
                                                <?php
