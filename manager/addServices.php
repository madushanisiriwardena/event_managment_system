                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Save New Services</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6 p-3">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="name" placeholder="Add Service Name...">
                                    </div>
                                    <div class="col-6 p-3">
                                        <div class="col-12">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <input type="number" class="form-control" id="pp_cost" min="0" oninput="validity.valid||(value='');" />
                                    ...
                                    <div class="col-6 p-3">
                                        ...
                                        <div class="input-group ">
                                            <span class="input-group-text">Rs.</span>
                                            <input type="number" class="form-control" id="pp_sale" min="0" oninput="validity.valid||(value='');" />
                                            <span class="input-group-text">.00</span>
                                        </div>
                                    </div>
                                    <div class="col-6 p-3">
                                        ...
                                        <div class="input-group ">
                                            <span class="input-group-text">Rs.</span>
                                            <input type="number" class="form-control" id="pp_ad" min="0" oninput="validity.valid||(value='');" />
                                            <span class="input-group-text">.00</span>
                                        </div>
                                    </div>
                                    <div class="col-8 p-3">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="description" placeholder="Add Service Name...">
                                    </div>
                                    ...
                                    <div class="col-4 offset-4 p-3">
                                        <button class="btn btn-primary btn-user btn-block" onclick="save_service();">
                                            Save Service
                                        </button>
                                    </div>
                                </div>
