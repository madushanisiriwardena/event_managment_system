...
?>
    ...
    <head>
        ...
        <title>Event Managment System - Pending Ad Tasks</title>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                            $resultset = Database::search("SELECT * FROM `additional_services` WHERE `vendors_id`='" . $vendor . "' AND `vendor_status_id` = '2' ORDER BY `id` DESC");
