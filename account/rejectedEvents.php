...
?>
    ...
    <head>
        ...
        <title>Event Managment System - My Rejected Events</title>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
                        <div class="breadcrumbs-content">
                            <h1 class="page-title">My Rejected Events</h1>
                            <ul class="breadcrumb-nav">
                                <li><a href="../index.php">Home</a></li>
                                <li>My Rejected Events</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-9 ">
                        <div class="tab-content">
                            <div class="tab-pane fade active show">
                                <?php
                                $rs2 = Database::search("SELECT * FROM `quotation` WHERE `customer_id` = '" . $customer . "'AND `quotation_status_id`='3' ORDER BY `id` DESC");
                                $n2 = $rs2->num_rows;
                                if($n2>0){
                                for ($x = 0; $x < $n2; $x++) {
                                ...
                                ?>
                                    <div class="card-body pb-2">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <br>
                                                <?php
                                                if ($category["quotation_status_id"] == "1") {
                                                ?>
                                                    <button class="btn btn-danger" onclick="delete_quote(<?php echo $category['id']; ?>);">Delete Request</button>
                                                <?php
                                                } else if ($category["quotation_status_id"] == "2") {
                                                ?>
                                                    ...
                                                    <a href="" class="btn btn-warning">Payment History</a>
                                                <?php
                                                } else if ($category["quotation_status_id"] == "3") {
                                                ?>
                                                    <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#r<?php echo $category["id"]; ?>">View Comment</button>
                                                    <a href="../chat.php?id=<?php echo $category["id"]; ?>" class="btn btn-info">Chat</a>
                                                    <?php
                                                } else if ($category["quotation_status_id"] == "4") {
                                                ...
                                                } else if ($category["quotation_status_id"] == "5") {
                                                    ?>
                                                    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#feedback<?php echo $category["id"]; ?>">Add Feedback</button>
                                                    <a href="chat.php?id=<?php echo $category["id"]; ?>" class="btn btn-info">Chat</a>
                                                <?php
                                                } else {
                                                ?>
                                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#reply<?php echo $category["id"]; ?>">Event Completed - Thank you</button>
                                                <?php
                                                }
                                                ?>
                                                <?php
                                                ...
                                                ?>
                                                    <a href="winfo.php?id=<?php echo $category["id"]; ?>" class="btn btn-primary">View More</a>
                                                <?php
                                                } else if ($srow21["categories_id"] == 6) {
                                                ?>
                                                    <a href="binfo.php?id=<?php echo $category["id"]; ?>" class="btn btn-primary">View More</a>
                                                <?php
                                                }
                                                ?>
                                            </div>
                                    ...
                                    <div class="modal fade" id="r<?php echo $category['id']; ?>" tabindex="-1" aria-labelledby="rLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="rlLabel">View Comment on Quotation</h1>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <h6 class="text-danger mt-3">Please Place a New Quotation From our Packages</h6>
                                                        </div>
                                                    </div>
                                                </div>
