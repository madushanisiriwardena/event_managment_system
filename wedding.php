...
?>
    ...
    <head>
        ...
        <title>Event Managment System - Plan your Wedding</title>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
                        <div class="breadcrumbs-content">
                            <h1 class="page-title">Plan your Wedding</h1>
                            <ul class="breadcrumb-nav">
                                <li><a href="index.php">Home</a></li>
                                <li>Plan your Wedding</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mt-5 mb-5">
            <div class="row">
                <div class="col-12 col-md-4 p-3">
                    <label class="form-label">Name of Bride</label>
                    <input type="text" class="form-control " id="bride">
                </div>
                <div class="col-12 col-md-4 p-3">
                    <label class="form-label">Name of Groom</label>
                    <input type="text" class="form-control " id="groom">
                </div>
                <div class="col-12 col-md-4 p-3">
                    <label class="form-label">Wedding Date & Time</label>
                ...
                <div class="col-12 col-md-7 p-3" id="a2">
                    ...
                    <select class="form-select" id="location" onchange="venue_add();">
                        ...
                        $rs3 = Database::search("SELECT * FROM `venues` WHERE `categories_id` = '5'");
                        $n3 = $rs3->num_rows;
...
");
        ...
        <div class="row">
            <div class="col-4 offset-4 mb-5 d-grid">
                <button class="btn btn-primary btn-user btn-block" onclick="submit_wed_quote(<?php echo $result['id']; ?>);">
                    Submit Quote
                </button>
            </div>
        </div>
