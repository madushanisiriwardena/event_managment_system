...
<head>
    ...
    <title>Event Managment System - Register Event Managers</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Register Event Managers</h1>
                    <!-- Content Row -->

                    <!-- Content Row -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Register a New Event Manager</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-6 offset-3 p-3">
                                    <button class="btn btn-primary btn-user btn-block" onclick="add_manager();">
                                        Register
                                    </button>
                                </div>
                            </div>
