...
?>
    ...
    <head>
        ...
        <title>Event Managment System - Add Categories</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Save New category</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-8 p-3">
                                        <label class="form-label">Enter a Description</label>
                                    ...
                                    <div class="col-12 offset-md-4 col-md-4 p-3">
                                        <button class="btn btn-primary btn-user btn-block" onclick="save_category();">
                                            Save Category
                                        </button>
                                    </div>
                                </div>
