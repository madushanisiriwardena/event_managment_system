                ...
                <div class="row align-items-center">
                    <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
                        <div class="breadcrumbs-content">
                            <h1 class="page-title">My Ongoing Events</h1>
                            <ul class="breadcrumb-nav">
                                <li><a href="../index.php">Home</a></li>
                                <li>My Ongoing Events</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-9 ">
                        <div class="tab-content">
                            <div class="tab-pane fade active show">
                                <?php
                                $rs2 = Database::search("SELECT * FROM `quotation` WHERE `customer_id` = '" . $customer . "' AND `quotation_status_id`='4' ORDER BY `id` DESC");
                                $n2 = $rs2->num_rows;
                                if($n2>0){
                                for ($x = 0; $x < $n2; $x++) {
                                ...
                                ?>
                                    <div class="card-body pb-2">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                ?>
                                                    <button class="btn btn-success" disabled>Payments Complete</button>
                                                <?php
                                                } else {
                                                ?>
                                    ...
                                    <div class="modal fade" id="more<?php echo $category['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">More Info About your Event</h1>
