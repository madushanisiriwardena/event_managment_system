...
?>
    ...
    <head>
        ...
        <title>Event Managment System - My Pending Events</title>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
                        <div class="breadcrumbs-content">
                            <h1 class="page-title">My Pending Events</h1>
                            <ul class="breadcrumb-nav">
                                <li><a href="../index.php">Home</a></li>
                                <li>My Pending Events</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-9 ">
                        <div class="tab-content">
                            <div class="tab-pane fade active show">
                                <?php
                                $rs2 = Database::search("SELECT * FROM `quotation` WHERE `customer_id` = '" . $customer . "' AND `quotation_status_id`='1' ORDER BY `id` DESC");
                                $n2 = $rs2->num_rows;
                                if($n2>0){
                                for ($x = 0; $x < $n2; $x++) {
                                    ...
                                    <div class="modal fade" id="feedback<?php echo $category['id']; ?>" tabindex="-1" aria-labelledby="feedbackLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                    <button class="btn btn-primary" onclick="add_feedback(<?php echo $category['id']; ?>);">Submit Feedback</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
