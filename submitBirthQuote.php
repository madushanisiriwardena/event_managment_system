                ...
                if ($n > 0) {
                    ...
                    if (empty($result["price"])) {
                        ...
                        try {
                            ...
                            $weddingQuery = "INSERT INTO `birthday`
            (`name`,`location_type`,`quotation_id`,`location_name`)
            VALUES ('" . $name . "','" . $lpp . "','" . $last_id . "','" . $loc . "')";
                            Database::iud($weddingQuery);
                        
                            if (Database::$connection->affected_rows === 0) {
                                throw new Exception("Error inserting into birthday: " . Database::$connection->error);
                            }
